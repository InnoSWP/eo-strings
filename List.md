...
# Full list
- ![EO](https://github.com/InnoSWP/eo-strings/blob/main/readme-assets/eo.svg)`append`  
...
- ![EO](https://github.com/InnoSWP/eo-strings/blob/main/readme-assets/eo.svg)`capitalize`  
Similar functions in other languages:    
  - Python: `capitalize`      
  - Ruby: `capitalize`    
...
- ![EO](https://github.com/InnoSWP/eo-strings/blob/main/readme-assets/eo.svg)`compare-ignore-case`  
Similar functions in other languages:  
...
- ![Java-EO](https://github.com/InnoSWP/eo-strings/blob/main/readme-assets/java-eo.svg)`compile-regexp`  
Similar functions in other languages:    
...
- ![EO](https://github.com/InnoSWP/eo-strings/blob/main/readme-assets/eo.svg)`contains`  
Similar functions in other languages:  
  - Java: `contains`    
  - Python: `in operator`      
  - Ruby: `include?`    
...
- ![EO](https://github.com/InnoSWP/eo-strings/blob/main/readme-assets/eo.svg)`count`  
Similar functions in other languages:    
  - Python: `count`      
  - Ruby: `count`    
...
- ![EO](https://github.com/InnoSWP/eo-strings/blob/main/readme-assets/eo.svg)`ends-with`  
Similar functions in other languages:  
  - Java: `endsWith`    
  - Python: `endswith`      
  - Ruby: `end_with?`    
...
Similar functions in other languages:  
  ...
  Should not be implemented:  
  Already implemented in base EO  
- ![EO](https://github.com/InnoSWP/eo-strings/blob/main/readme-assets/eo.svg)`equals-ignore-case`  
Similar functions in other languages:  
  ...
  Should not be implemented:  
  Can be done in a few lines using to-lowercase and compare  
- ![EO](https://github.com/InnoSWP/eo-strings/blob/main/readme-assets/eo.svg)`fill-left`  
Similar functions in other languages:        
  - Ruby: `ljust`    
...
- ![EO](https://github.com/InnoSWP/eo-strings/blob/main/readme-assets/eo.svg)`fill-right`  
Similar functions in other languages:        
  - Ruby: `rjust`    
  ...
  Should not be implemented:  
  Can be done with one for loop  
- ![EO](https://github.com/InnoSWP/eo-strings/blob/main/readme-assets/eo.svg)`fill-zero-left`  
Similar functions in other languages:    
  - Python: `zfill`      
  - Ruby: `ljust(int, '0')`    
  ...
  Should not be implemented:  
  Can be done with one for loop  
- ![EO](https://github.com/InnoSWP/eo-strings/blob/main/readme-assets/eo.svg)`fill-zero-right`  
Similar functions in other languages:        
  - Ruby: `rjust(int, '0')`    
  ...
  Should not be implemented:  
  Can be done with one for loop  
- ![Java-EO](https://github.com/InnoSWP/eo-strings/blob/main/readme-assets/java-eo.svg)`find-all`            
...
- ![Java-EO](https://github.com/InnoSWP/eo-strings/blob/main/readme-assets/java-eo.svg)`find-all-regexp`  
Similar functions in other languages:    
...
- ![Java-EO](https://github.com/InnoSWP/eo-strings/blob/main/readme-assets/java-eo.svg)`find-first`  
Similar functions in other languages:  
  - Java: `indexOf`    
  - Python: `find`    
  - C++: `find`    
  ...
  Should be implemented:  
  All regular find function have better performance compared to regexp ones  
- ![Java-EO](https://github.com/InnoSWP/eo-strings/blob/main/readme-assets/java-eo.svg)`find-first-regexp`            

  Returns the index of the first occurrence of the pattern.   
  Should be implemented:  
  Essential for regexp operations  
- ![Java-EO](https://github.com/InnoSWP/eo-strings/blob/main/readme-assets/java-eo.svg)`find-last`  
Similar functions in other languages:  
  - Java: `lastIndexOf`    
  - Python: `rfind`      
  - Ruby: `rindex`    
  ...
  Should be implemented:  
  All regular find function have better performance compared to regexp ones  
- ![Java-EO](https://github.com/InnoSWP/eo-strings/blob/main/readme-assets/java-eo.svg)`find-last-regexp`            
...
Similar functions in other languages:  
  ...
  Should not be implemented:  
  Already implemented in base EO  
- ![EO](https://github.com/InnoSWP/eo-strings/blob/main/readme-assets/eo.svg)`insert`  
Similar functions in other languages:      
  - C++: `insert`    
  - Ruby: `insert`    
...
- ![EO](https://github.com/InnoSWP/eo-strings/blob/main/readme-assets/eo.svg)`is-alphabetic`  
Similar functions in other languages:    
  - Python: `isalpha`    
  - C++: `isalpha`      
...
- ![EO](https://github.com/InnoSWP/eo-strings/blob/main/readme-assets/eo.svg)`is-empty`  
Similar functions in other languages:  
  - Java: `isEmpty`        
  - Ruby: `empty?`    
...
- ![EO](https://github.com/InnoSWP/eo-strings/blob/main/readme-assets/eo.svg)`is-hexadecimal`  
Similar functions in other languages:  
  - Java: `isHexDigit`      
  - C++: `isxdigit`      
  ...
  Should not be implemented:  
  Can be done in regular expressions  
- ![EO](https://github.com/InnoSWP/eo-strings/blob/main/readme-assets/eo.svg)`is-int`  
Similar functions in other languages:    
  - Python: `isdigit`    
  - C++: `isdigit`      
  ...
  Should not be implemented:  
  Can be done in regular expressions  
- ![EO](https://github.com/InnoSWP/eo-strings/blob/main/readme-assets/eo.svg)`is-lowercase`  
Similar functions in other languages:  
  - Java: `isLowerCase`    
  - Python: `islower`        
  ...
  Should not be implemented:  
  Can be done in regular expressions  
- ![EO](https://github.com/InnoSWP/eo-strings/blob/main/readme-assets/eo.svg)`is-title`  
Similar functions in other languages:    
  - Python: `istitle`        
  ...
  Should not be implemented:  
  Can be done in regular expressions  
- ![EO](https://github.com/InnoSWP/eo-strings/blob/main/readme-assets/eo.svg)`is-uppercase`  
Similar functions in other languages:  
  - Java: `isUpperCase`    
  - Python: `isupper`        
  ...
  Should not be implemented:  
  Can be done in regular expressions  
- ![EO](https://github.com/InnoSWP/eo-strings/blob/main/readme-assets/eo.svg)`is-whitespace`  
Similar functions in other languages:  
  - Java: `isBlank`    
  - Python: `isspace`        
...
Similar functions in other languages:  
  ...
  Should not be implemented:  
  Already implemented in base EO  
- ![Java-EO](https://github.com/InnoSWP/eo-strings/blob/main/readme-assets/java-eo.svg)`matches-regexp`  
Similar functions in other languages:  
  - Java: `matches`    
  - Python: `re.match`      
  - Ruby: `match?`    
...
- ![EO](https://github.com/InnoSWP/eo-strings/blob/main/readme-assets/eo.svg)`partition`  
Similar functions in other languages:    
  - Python: `partition`      
  - Ruby: `partition`    
...
- ![EO](https://github.com/InnoSWP/eo-strings/blob/main/readme-assets/eo.svg)`repeat`  
Similar functions in other languages:  
  - Java: `repeat`    
  - Python: `* operator`        
...
- ![Java-EO](https://github.com/InnoSWP/eo-strings/blob/main/readme-assets/java-eo.svg)`replace-all`  
Similar functions in other languages:  
  - Java: `replaceAll`    
  - Python: `replace`    
  - C++: `replace`    
  ...
  Should be implemented:  
  All regular find function have better performance compared to regexp ones  
- ![Java-EO](https://github.com/InnoSWP/eo-strings/blob/main/readme-assets/java-eo.svg)`replace-all-regexp`  
Similar functions in other languages:  
...
- ![Java-EO](https://github.com/InnoSWP/eo-strings/blob/main/readme-assets/java-eo.svg)`replace-first`  
Similar functions in other languages:  
  - Java: `replaceFirst`        
  - Ruby: `sub!`    
  ...
  Should be implemented:  
  All regular find function have better performance compared to regexp ones  
- ![Java-EO](https://github.com/InnoSWP/eo-strings/blob/main/readme-assets/java-eo.svg)`replace-first-regexp`  
Similar functions in other languages:  
  ...
  Should be implemented:  
  Too cumbersome to implement through other functions  
- ![Java-EO](https://github.com/InnoSWP/eo-strings/blob/main/readme-assets/java-eo.svg)`replace-last`            
...
Similar functions in other languages:      
  ...
  Should not be implemented:  
  Unapplicable to EO  
- ![EO](https://github.com/InnoSWP/eo-strings/blob/main/readme-assets/eo.svg)`right-partition`  
Similar functions in other languages:    
  - Python: `rpartition`        
...
Similar functions in other languages:      
  ...
  Should not be implemented:  
  Unapplicable to EO  
- ![Java-EO](https://github.com/InnoSWP/eo-strings/blob/main/readme-assets/java-eo.svg)`split`  
Similar functions in other languages:  
  - Java: `split`    
  - Python: `split`      
  - Ruby: `split`    
...
- ![Java-EO](https://github.com/InnoSWP/eo-strings/blob/main/readme-assets/java-eo.svg)`split-regexp`  
Similar functions in other languages:  
  - Java: `s.split("regex")`    
...
- ![EO](https://github.com/InnoSWP/eo-strings/blob/main/readme-assets/eo.svg)`starts-with`  
Similar functions in other languages:  
  - Java: `startsWith`    
  - Python: `startswith`      
  - Ruby: `start_with?`    
...
Similar functions in other languages:  
  ...
  Should not be implemented:  
  Already implemented in base EO  
- ![Java-EO](https://github.com/InnoSWP/eo-strings/blob/main/readme-assets/java-eo.svg)`substring`  
Similar functions in other languages:  
...
- ![EO](https://github.com/InnoSWP/eo-strings/blob/main/readme-assets/eo.svg)`swap-case`  
Similar functions in other languages:    
  - Python: `swapcase`      
  - Ruby: `swapcase`    
...
Similar functions in other languages:  
  ...
  Should not be implemented:  
  Already implemented in base EO  
- ![EO](https://github.com/InnoSWP/eo-strings/blob/main/readme-assets/eo.svg)`to-lowercase`  
Similar functions in other languages:  
  - Java: `toLowerCase`    
  - Python: `lower`    
  - C++: `toLowerCase`    
...
- ![EO](https://github.com/InnoSWP/eo-strings/blob/main/readme-assets/eo.svg)`to-uppercase`  
Similar functions in other languages:  
  - Java: `toUpperCase`    
  - Python: `upper`    
  - C++: `toUpperCase`    
...
- ![EO](https://github.com/InnoSWP/eo-strings/blob/main/readme-assets/eo.svg)`trim-left`  
Similar functions in other languages:  
  - Java: `stripLeading`    
  - Python: `lstrip`      
  - Ruby: `lstrip`    
...
- ![EO](https://github.com/InnoSWP/eo-strings/blob/main/readme-assets/eo.svg)`trim-right`  
Similar functions in other languages:  
  - Java: `stripTrailing`    
  - Python: `rstrip`        
